     ...
     return (() => {
          ...
          function p(t, e = (t) => t) {
               function o(o) {
                    ...
                    let i = 0,
                         s = t.selectionStart;
                    (t.value = t.value.replace(/[\d.]+/g, (t, o) => (o <= s && o + t.length >= s ? ((s = o), e(Number(t), n, i)) : (i++, t)))),
                         t.focus(),
                         ...
                         return (
                              ...
                              this._eventBindings.push(
                                   i(s, "click", () => {
                                        ...
                                        console.log([...s.parentElement.children].indexOf(s)); //key function!! return swatch index!!
                                   })
                              ),
                              !0
                         );
